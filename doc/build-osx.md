...
2.  Build HellenicCoin:

    Configure and build the headless HellenicCoin binaries as well as the GUI (if Qt is found).
...
## Running
HellenicCoin is now available in `./src/helleniccoind`

Before running, you may create an empty configuration file:
```shell
mkdir -p "/Users/${USER}/Library/Application Support/Peercoin"

touch "/Users/${USER}/Library/Application Support/Peercoin/Helleniccoin.conf"

chmod 600 "/Users/${USER}/Library/Application Support/Helleniccoin/Helleniccoin.conf"
```
...
```shell
tail -f $HOME/Library/Application\ Support/Helleniccoin/debug.log
```
