...
//
bool CheckStakeKernelHash(unsigned int nBits, CBlockIndex* pindexPrev, const CBlockHeader& blockFrom, unsigned int nTxPrevOffset, const CTransaction& txPrev, const COutPoint& prevout, unsigned int nTimeTx, uint256& hashProofOfStake, bool fPrintProofOfStake)
{
    const Consensus::Params& params = Params().GetConsensus();
    ...
    hashProofOfStake = bnTarget.getuint256();
...
unsigned int GetStakeEntropyBit(const CBlock& block)
{
        ...
        unsigned int nEntropyBit = hashSig.GetDataPtr()[4] >> 31;  // take the first bit of the hash
        if (gArgs.GetBoolArg("-printstakemodifier", false))
