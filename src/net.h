...
/** helleniccoin: Number of consecutive PoS headers are allowed from a single peer. Used to prevent out of memory attack. */
...
public:
    ...
    uint256 hashCheckpointKnown; // helleniccoin: known sent sync-checkpoint
    ...
    // helleniccoin: used to detect branch switches
