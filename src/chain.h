...
// helleniccoin
    // helleniccoin: money supply related block index fields
    int64_t nMint{0};
    int64_t nMoneySupply{0};

    // helleniccoin: proof-of-stake related block index fields
    unsigned int nFlags{0};  // helleniccoin: block index flags
    enum
    {
